...
; RUN: opt -S -mtriple=amdgcn-amd-amdhsa -amdgpu-promote-alloca -opaque-pointers < %s | FileCheck %s
...
; CHECK-NEXT:    store i32 [[FOO1]], ptr [[I]], align 4
; CHECK-NEXT:    [[FOO2:%.*]] = getelementptr [[BLOCK]], ptr addrspace(1) @block, i32 0, i32 0
; CHECK-NEXT:    [[FOO3:%.*]] = load [1 x float], ptr addrspace(1) [[FOO2]], align 4
; CHECK-NEXT:    store [1 x float] [[FOO3]], ptr [[F1]], align 4
; CHECK-NEXT:    [[FOO4:%.*]] = load i32, ptr [[I]], align 4
; CHECK-NEXT:    [[FOO5:%.*]] = getelementptr [1 x float], ptr [[F1]], i32 0, i32 [[FOO4]]
; CHECK-NEXT:    [[FOO6:%.*]] = load float, ptr [[FOO5]], align 4
; CHECK-NEXT:    [[FOO7:%.*]] = alloca <4 x float>, align 16
; CHECK-NEXT:    [[FOO8:%.*]] = load <4 x float>, ptr [[FOO7]], align 16
...
; CHECK-NEXT:    [[FOO13:%.*]] = getelementptr [[GL_PERVERTEX:%.*]], ptr addrspace(1) @pv, i32 0, i32 0
; CHECK-NEXT:    store <4 x float> [[FOO12]], ptr addrspace(1) [[FOO13]], align 16
; CHECK-NEXT:    ret void
;
  %i = alloca i32
  %f1 = alloca [1 x float]
...
; CHECK-NEXT:    [[FOO:%.*]] = getelementptr [[BLOCK2:%.*]], ptr addrspace(1) @block2, i32 0, i32 0
; CHECK-NEXT:    [[FOO1:%.*]] = load i32, ptr addrspace(1) [[FOO]], align 4
; CHECK-NEXT:    store i32 [[FOO1]], ptr [[I]], align 4
; CHECK-NEXT:    [[FOO2:%.*]] = load i32, ptr [[I]], align 4
; CHECK-NEXT:    [[FOO3:%.*]] = sitofp i32 [[FOO2]] to float
; CHECK-NEXT:    [[FOO4:%.*]] = getelementptr [2 x float], ptr [[F1]], i32 0, i32 0
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x float>, ptr [[F1]], align 8
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <2 x float> [[TMP1]], float [[FOO3]], i32 0
; CHECK-NEXT:    store <2 x float> [[TMP2]], ptr [[F1]], align 8
; CHECK-NEXT:    [[FOO5:%.*]] = getelementptr [2 x float], ptr [[F1]], i32 0, i32 1
; CHECK-NEXT:    [[TMP3:%.*]] = load <2 x float>, ptr [[F1]], align 8
; CHECK-NEXT:    [[TMP4:%.*]] = insertelement <2 x float> [[TMP3]], float 2.000000e+00, i64 1
; CHECK-NEXT:    store <2 x float> [[TMP4]], ptr [[F1]], align 8
; CHECK-NEXT:    [[FOO6:%.*]] = load [2 x float], ptr [[F1]], align 4
...
; CHECK-NEXT:    [[FOO8:%.*]] = getelementptr [[GL_PERVERTEX:%.*]], ptr addrspace(1) @pv, i32 0, i32 0
; CHECK-NEXT:    store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, ptr addrspace(1) [[FOO8]], align 16
; CHECK-NEXT:    ret void
;
  %i = alloca i32
  %f1 = alloca [2 x float]
...
; CHECK-NEXT:    [[FOO1:%.*]] = load i32, ptr addrspace(1) [[FOO]], align 4
; CHECK-NEXT:    store i32 [[FOO1]], ptr [[I]], align 4
; CHECK-NEXT:    [[FOO2:%.*]] = getelementptr [[BLOCK3]], ptr addrspace(1) @block3, i32 0, i32 0
; CHECK-NEXT:    [[FOO3:%.*]] = load [2 x float], ptr addrspace(1) [[FOO2]], align 4
; CHECK-NEXT:    store [2 x float] [[FOO3]], ptr [[F1]], align 4
; CHECK-NEXT:    [[FOO4:%.*]] = load i32, ptr [[I]], align 4
; CHECK-NEXT:    [[FOO5:%.*]] = getelementptr [2 x float], ptr [[F1]], i32 0, i32 [[FOO4]]
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x float>, ptr [[F1]], align 8
...
; CHECK-NEXT:    [[TMP1:%.*]] = load <5 x float>, ptr addrspace(5) [[F1]], align 32
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <5 x float> [[TMP1]], float 1.000000e+00, i64 1
; CHECK-NEXT:    store <5 x float> [[TMP2]], ptr addrspace(5) [[F1]], align 32
...
; CHECK-NEXT:    [[TMP7:%.*]] = load <5 x float>, ptr addrspace(5) [[F1]], align 32
...
; CHECK-NEXT:    store [2 x double] [[FOO5]], ptr [[S]], align 8
; CHECK-NEXT:    [[FOO6:%.*]] = getelementptr [2 x double], ptr [[S]], i32 0, i32 1
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x double>, ptr [[S]], align 16
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <2 x double> [[TMP1]], i64 1
; CHECK-NEXT:    [[FOO8:%.*]] = getelementptr [2 x double], ptr [[S]], i32 0, i32 1
; CHECK-NEXT:    [[TMP3:%.*]] = load <2 x double>, ptr [[S]], align 16
; CHECK-NEXT:    [[TMP4:%.*]] = extractelement <2 x double> [[TMP3]], i64 1
; CHECK-NEXT:    [[FOO10:%.*]] = fadd double [[TMP2]], [[TMP4]]
; CHECK-NEXT:    [[FOO11:%.*]] = getelementptr [2 x double], ptr [[S]], i32 0, i32 0
; CHECK-NEXT:    [[TMP5:%.*]] = load <2 x double>, ptr [[S]], align 16
; CHECK-NEXT:    [[TMP6:%.*]] = insertelement <2 x double> [[TMP5]], double [[FOO10]], i32 0
; CHECK-NEXT:    store <2 x double> [[TMP6]], ptr [[S]], align 16
; CHECK-NEXT:    [[FOO12:%.*]] = getelementptr [2 x double], ptr [[S]], i32 0, i32 0
; CHECK-NEXT:    [[TMP7:%.*]] = load <2 x double>, ptr [[S]], align 16
; CHECK-NEXT:    [[TMP8:%.*]] = extractelement <2 x double> [[TMP7]], i32 0
; CHECK-NEXT:    [[FOO14:%.*]] = getelementptr [2 x double], ptr [[S]], i32 0, i32 1
; CHECK-NEXT:    [[TMP9:%.*]] = load <2 x double>, ptr [[S]], align 16
